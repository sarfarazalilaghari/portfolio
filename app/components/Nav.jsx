...
const Nav = () => {
  ...
  <div className="max-w-screen-xl flex items-center justify-between mx-auto p-4">
    ...
    {/* Menu Items */}
    <div
      className={`menu ${menuOpen ? 'block w-full mt-80 absolute  md:flex md:w-auto md:order-1' : 'hidden w-full   md:flex md:w-auto md:order-1'}`}
    >
      <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700 md:flex-row md:space-x-8 rtl:space-x-reverse">
        <li>
          <Link
            href="/"
            className="block py-2 px-3 text-white bg-blue-700 rounded-sm md:bg-transparent md:text-blue-700 md:p-0 md:dark:text-blue-500"
